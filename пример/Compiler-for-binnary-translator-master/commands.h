...
DEF_CMD(DIV, SIMPLE_COMMAND(DIV, 39), OPERATIONS(DIV, /), SIMPLE_COMMAND_DIS(DIV))//11

DEF_CMD(OUT, SIMPLE_COMMAND(OUT, 194), case OUT://194
            EMPTY_STACK
            {
                printf ("%g\n", cpu.stck.Pop ());
            }
...
DEF_CMD(SQRT, SIMPLE_COMMAND(SQRT, 8), MATH(sqrt, SQRT), SIMPLE_COMMAND_DIS(SQRT))
